...
<html>
<head>
    <title>Paiement par Carte - Bujamart</title>
...
<div class="container">
    ...
    <h1>Paiement Par carte bancaire <br/> Bujamart</h1>
            ...
            <div class="panel panel-default credit-card-box">
                <div class="panel-heading display-table" >
                    <div class="row display-tr" >
                        <h3 class="panel-title display-td" >Informations de Paiement</h3>
                ...
                <div class="panel-body">
                    ...
                    <form 
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Payer Maintenant ({{ Session::get('cart')->totalPrice + 3000 }} BIF)</button>
                            </div>
                        </div>
